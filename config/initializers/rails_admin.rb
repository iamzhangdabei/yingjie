# RailsAdmin config file. Generated on March 01, 2013 21:13
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Yingjie', 'Admin']
  ...
  # config.excluded_models = ['Article', 'Category', 'Page', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Article', 'Category', 'Page', 'User']
